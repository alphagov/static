...
class SanitiserTest < ActiveSupport::TestCase
  ...
  test "with query being incorrect percent-encoded UTF-8 string raises UndefinedConversionError" do
  ...
  test "with cookie path being incorrect percent-encoded UTF-8 raises UndefinedConversionError" do
