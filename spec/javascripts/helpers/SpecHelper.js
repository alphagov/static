    ...
    toBeEqualAsJSON: function (util, customEqualityTesters) {
      return {
        compare: function (actual, expected) {
          ...
          if (result.pass) { result.message = 'Expected ' + actualAsJSON + ' not to be equal to ' + expectedAsJSON + ' once converted to JSON' } else { result.message = 'Expected ' + actualAsJSON + ' to be equal to ' + expectedAsJSON + ' once converted to JSON' }
