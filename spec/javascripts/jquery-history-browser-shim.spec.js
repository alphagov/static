describe("jQuery.historyBrowserShim", function () {
  ...
  it("should correctly match browser versions based on user agents, equivalent to jQuery 1.9.1", function () {
    for (var i = 0, l = uas.length; i < l; i++) {
      var parts = uas[i],
          match = jQuery.historyBrowserShim.uaMatch(parts[2]);

      expect(parts[0]).toEqual(match.browser);
      expect(parts[1]).toEqual(match.version);
    }
  });
});
